...
namespace lab8
{
    ...
    class ClassRoom : IEnumerable<Student>
    {
        ...
        {
            foreach (Student toReturnStudent in StudentList)
            {
                yield return toReturnStudent;
            }
    ...
    class Program
    {
        private static void Main()
        {
            ...
            ClassRoom classR = new ClassRoom("1234", "Dr. Bill Dale");
            ...
            try
            {
                ...
                Console.WriteLine("Class Room Number:\t" + classR.Crn + "\nLecturer:\t\t" + classR.LecturerName + "\n\n");
                foreach (Student s in classR)
                {
                    Console.WriteLine(s + "\n");
                }
